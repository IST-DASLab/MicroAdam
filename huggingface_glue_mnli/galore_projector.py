...
class GaLoreProjector:
    ...
    def project(self, full_rank_grad, iter):
        ...
        #     print(f'Error in GaLoreProjector {iter=}, {full_rank_grad.shape=}, nans={torch.isnan(full_rank_grad).sum() / full_rank_grad.numel() * 100.:.2f}%')
        #     sys.exit(666)
    ...
    def get_orthogonal_matrix(self, weights, rank, type):
        ...
        # print(f'Running SVD-{type} for weights of shape {matrix.shape}')
